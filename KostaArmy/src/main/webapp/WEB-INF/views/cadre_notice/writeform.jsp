						...
						<div class="datagrid" style="overflow-y: hidden;">
							<table>
								<thead style="font-size: 30px;">
									<tr>
										<th colspan="2">공지사항 &nbsp <small>[글쓰기]</small></th>
									</tr>
								</thead>
							</table>
								...
								<div class="datagrid" style="margin: 10px">
									<table>
										...
										<tr>
											...
											<td>
												<textarea class="form-control" name="content" id="content" placeholder="내용을 입력해주세요" 
												maxlength="2048" style="height: 350px; resize: none;"></textarea>
											</td>
										</tr>
										<tr align="center">
											<td colspan="2">
												<input type="submit" class="btn btn-success btn-lg" value="완료" style="width: 49%;">
